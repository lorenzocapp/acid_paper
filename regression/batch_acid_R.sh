...
#SBATCH --job-name=k_regr			    ### Job Name
#SBATCH -o /homes/users/lcappello/scratch/output/k_regr_%A_%a.out	  ### File in which to store job output/error
#SBATCH -e  /homes/users/lcappello/scratch/error/k_regr_%A_%a.err        ### error file messages. 
...
Rscript --vanilla master_kernel_regr.R ${i} ${outFile}
