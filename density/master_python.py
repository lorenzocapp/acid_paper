...
def run_copula_algo(y,rho):
    ...
    rho_new = jnp.maximum(copula_density_obj.rho_opt, rho)
...
for n in n_values:
    for rho in rho_values:
        ...
        logcdf_conditionals_pr,logpdf_joints_pr = run_copula_algo(y,rho)
        nameout = f"output_py/out_python_n{n}_{i}_{rho}"
